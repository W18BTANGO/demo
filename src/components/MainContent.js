  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
      <div>
        ...
        <Typography>Using data to find the home perfect for you. Our final product is still in development. Please 
          enjoy our suite of developer tools in the meantime.
        </Typography>
      </div>
      <Box
        sx={{
